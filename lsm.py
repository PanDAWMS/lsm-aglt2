...
# At AGLT2 increase from 30/300/30 to 120/300/120
tmoConnect       =  120.00
tmoTransfer      =  300.00
tmoMinTransfer   =  120.00
# Number of seconds to move a MB
# At AGLT2 increase tmoPerMB to 1.00 from 0.25
tmoPerMB         =    1.00
tmoFAXmultiplier =    3
...
# The AGLT2 prefixes for the different protocols
prefixXRD        = "root://xrootd.aglt2.org:1094"
...
esIndexBase       = 'http://atlas-kibana.mwt2.org:9200/lsm_aglt2-%s.%s' % ( str(datetime.utcnow().year), str(datetime.utcnow().month) )
